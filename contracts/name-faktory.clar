...
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://bncytzyfafclmdxrwpgq.supabase.co/storage/v1/object/public/tokens/60360b67-5f2e-4dfb-adc4-f8bf7c9aab85.json"))
...
;; Batch token sending functionality
;; ---------------------------------------------------------
