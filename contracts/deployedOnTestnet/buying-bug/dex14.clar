;; a90f538a4812698160087274ad506ff52d6c8f922971a9947c40ba59d18ce7fc
      ...
      (define-constant DEX-TOKEN 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.simple14-faktory)
      (define-constant PRE-CONTRACT 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.simple14-pre-faktory)
                  ...
                  (try! (as-contract 
                         (contract-call? 
                           'ST295MNE41DC74QYCPRS8N37YYMC06N6Q3VQDZ6G1.xyk-core-v-1-2 
                               create-pool 
                               'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.xyk-pool-sbtc-simple14-v-1-1
                               SBTC 
                               ft
                               amm-ustx 
                               amm-amount 
        ...
        (begin
          ...
          (var-set open true) ;; remove this when ready to link up to pre-contract mainnet
            (print { 
                ...
                poolName: 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.xyk-pool-sbtc-simple14-v-1-1
           })
          (ok true))