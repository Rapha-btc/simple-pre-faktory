;; https://stxer.xyz/simulations/mainnet/5c6cfbfcb3161dedfda3af87bb7c6487 runs deploy
...
(use-trait faktory-token 'SP3XXMS38VTAWTVPE5682XSBFXPTH7XCPEBTX8AN2.faktory-trait-v1.sip-010-trait) ;; STTWD9SPRQVD3P733V89SV0P8RZRZNQADG034F0A
...
(define-public (buy-up-to (seat-count uint))
    (let (
        ...
        ;; Process payment
        (match (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token transfer (* PRICE-PER-SEAT actual-seats) tx-sender (as-contract tx-sender) none)
            success 
                (begin
...
(define-public (refund)
    (let (
        ...
        ;; Process refund
        (match (as-contract (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token transfer (* PRICE-PER-SEAT user-seats) tx-sender seat-owner none))
            success 
...
(define-private (initialize-token-distribution)
    (begin
        ...
        (try! (as-contract (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token transfer DEX-AMOUNT tx-sender DEX-DAO none))) ;; 0.00250000 BTC to DEX  
        (try! (as-contract (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token transfer MULTI-SIG-AMOUNT tx-sender FAKTORY1 none))) ;; 0.00010000 BTC  -> covers contract deployment gaz fees
        (try! (as-contract (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token transfer FEE-AMOUNT tx-sender FAKTORY2 none)))  ;; 0.00140000 BTC fees -> covers ordinals bot, xlink and faktory
...
(define-private (distribute-to-holder (entry {owner: principal, seats: uint}))
    (let ((holder (get owner entry))
        ...
        (if (> user-share u0)
            (match (as-contract (contract-call? 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token transfer user-share tx-sender holder none))
                success
                    (begin 
